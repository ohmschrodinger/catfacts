...
const CatFactImage = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-[#171B23] p-4 font-sans">
      ...
      <div className="bg-[#212634] rounded-2xl shadow-xl border border-[#2f3645] max-w-md w-full p-8 text-center relative flex flex-col justify-between transition-all duration-300 min-h-[500px]">
